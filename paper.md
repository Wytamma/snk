...
![Figure 1: The `variant-calling` CLI generated by Snk.](docs/images/variant-calling-cli.png)
...
![Figure 2: The the run command of the `variant-calling` CLI dynamically generated from the Snakemake configfile.](docs/images/variant-calling-cli-run.png)
